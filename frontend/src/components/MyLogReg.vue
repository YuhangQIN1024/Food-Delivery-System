            ...
            <div v-show="target == 1">
                <el-form label-width="0" class="login_form" :model="login_form" :rules="login_rules" ref="login_form">
                    ...
                    <el-form-item class="btns">
                        ...
                        <el-button type="primary" @click="login_manager()">管理员登录</el-button>
                    </el-form-item>
        ...
        <div class="reg_box" v-show="target == 2">
            ...
            <div>
                <el-form class="reg_form" :model="reg_form" :rules="reg_rules" ref="reg_form">
                    ...
                    <!-- 按钮 -->
                    <el-form-item class="btns">
                        <el-button type="primary" @click="llogin()">注册</el-button>
                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        async login_manager() {
            ...
            this.$axios.post("/api/user/login_manager", this.login_form).then((res) => {
                console.log(res.status);
                //200登录成功
                if (res.data.code != 200) {
                    return this.$message({
