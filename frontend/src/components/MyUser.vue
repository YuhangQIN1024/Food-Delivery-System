    ...
    <div>
        ...
        <div class="body">
                ...
                <el-menu default-active="1" class="el-menu-vertical-demo" background-color="#545c64" text-color="#fff"
                    ...
                    <el-submenu index="2">
                        ...
                        <el-menu-item-group>
                            ...
                            <el-menu-item index="4">大额订单</el-menu-item>
                            <el-menu-item index="5">小额订单</el-menu-item>
                        </el-menu-item-group>
                    ...
                    <el-submenu>
                        ...
                        <el-menu-item-group>
                            ...
                            <el-menu-item index="8">修改信息</el-menu-item>
            ...
            <div class="main">
                ...
                <div id="changemsg" v-show="active == 8">
                    <changemsg></changemsg>
                </div>
...
import changemsg from '@/components/UserMsg/ChMsg.vue'
export default {
    components: {
        usershop: usershop,
        // userfinished: userfinished,
